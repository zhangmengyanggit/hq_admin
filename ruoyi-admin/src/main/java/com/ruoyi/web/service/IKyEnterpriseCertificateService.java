 ...
 * @date 2023-04-21
 */
public interface IKyEnterpriseCertificateService 
{
    /**
     * 查询企业证书详情
     * 
     ...
     * 同步企业证书到本地
     *
     * @param kyEnterpriseCertificate 企业证书信息
     * @return 结果
     */
    AjaxResult syncToLocalEnterprise(KyEnterpriseComprehensiveInformation kyEnterpriseCertificate);
}
